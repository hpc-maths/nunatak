...
| `sample/26.5.2/darwin-arm64/triad-c` | macOS 26.5.2, Apple M5 Max, 2026-08-23 | temporal mode via /usr/bin/sample, triad built `cc -O2 -g`, warmed binary (a first launch loses the image list), no LLVM on the machine |

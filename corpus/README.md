...
| `xctrace/16.0/darwin-arm64/triad-c-power` | macOS 26.5.2, Apple M5 Max, 2026-08-23 | the powermetrics rider around the Time Profiler recording: sudoers probe, filtered plist stream, per-process and package energy |
